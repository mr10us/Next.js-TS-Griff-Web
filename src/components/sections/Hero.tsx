...
export const Hero = () => {
  return (
    <section
      ...
      className="hero-overlay h-[600px] w-full bg-cover bg-center md:h-[800px]"
    >
      <div className="container flex h-full flex-col justify-center gap-4 pt-72 tracking-widest">
