...
export const Footer = () => {
  return (
    <footer className="bg-secondary py-10 font-grotesk text-white">
      <div className="container flex flex-wrap w-full justify-center gap-6 md:grid md:grid-cols-[auto_repeat(3,1fr)] lg:gap-10">
        ...
        <div className="row-span-2 mb-6 grid grid-rows-subgrid gap-3 sm:justify-start md:justify-stretch">
